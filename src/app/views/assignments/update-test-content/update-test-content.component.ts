...
export class UpdateTestContentComponent implements OnInit {
  ...
  downloadFile(data, filename='data') {
      let csvData = this.ConvertToCSV(data, ['id','name','passageContent','description', 'difficultyLevel', 'explanation', 'positiveMark',
      'negativeMark','skipMark','topic','subTopic','type'    ]);
      console.log(csvData)
